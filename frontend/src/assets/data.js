...
export const products = [
  ...
  },
  {
    ...
    description:
      "Durable and stylish slim fit jeans, suitable for both casual and formal outfits.",
    price: 380,
    soldedPrice: 75,
    onSolde: false,
    image: [img11],
  ...
  },
  {
    ...
    description:
      "Comfortable joggers made for active kids, featuring an elastic waistband for easy wear.",
    price: 170,
    soldedPrice: 75,
    onSolde: false,
    image: [img12],
  ...
  },
  {
    ...
    description:
      "Trendy mid-rise skinny jeans, made to pair well with any top for a chic look.",
    price: 290,
    soldedPrice: 75,
    onSolde: false,
    image: [img13],
  ...
  },
  {
    ...
    description:
      "Rugged cargo pants featuring multiple pockets, ideal for casual or outdoor adventures.",
    price: 290,
    soldedPrice: 75,
    onSolde: false,
    image: [img14],
  ...
  },
  {
    ...
    description:
      "Comfortable elastic waist shorts designed for active boys, ideal for play and outdoor activities.",
    price: 150,
    soldedPrice: 75,
    onSolde: false,
    image: [img15],
  ...
  },
  {
    ...
    description:
      "Soft and stretchy floral print leggings, perfect for comfort and style.",
    price: 210,
    soldedPrice: 75,
    onSolde: false,
    image: [img16],
  ...
  },
  {
    ...
    description:
      "Stylish and warm puffer jacket, great for layering in chilly weather.",
    price: 490,
    soldedPrice: 75,
    onSolde: false,
    image: [img17],
  ...
  },
  {
    ...
    description:
      "A timeless trench coat with a tailored fit, perfect for any occasion.",
    price: 610,
    soldedPrice: 75,
    onSolde: false,
    image: [img18],
  ...
  },
  {
    ...
    description:
      "Warm winter parka with a durable build, designed to withstand cold temperatures.",
    price: 350,
    soldedPrice: 75,
    onSolde: false,
    image: [img19],
  ...
  },
  {
    ...
    description:
      "A versatile denim jacket for girls, great for layering in all seasons.",
    price: 260,
    soldedPrice: 75,
    onSolde: false,
    image: [img20],
  ...
  },
  {
    ...
    description:
      "This warm wool blend sweater provides both comfort and a stylish look.",
    price: 360,
    soldedPrice: 75,
    onSolde: false,
    image: [img21],
  ...
  },
  {
    ...
    description:
      "Durable denim jacket with a vintage finish, suitable for layering in all seasons.",
    price: 400,
    soldedPrice: 75,
    onSolde: false,
    image: [img22],
  ...
  },
  {
    ...
    description:
      "Trendy faux leather jacket with sleek zipper details, adding an edgy touch to any outfit.",
    price: 470,
    soldedPrice: 75,
    onSolde: false,
    image: [img24],
  ...
  },
  {
    ...
    description:
      "Soft winter gloves with a fleece lining, designed to keep hands warm.",
    price: 100,
    soldedPrice: 75,
    onSolde: false,
    image: [img25],
  ...
  },
  {
    ...
    description:
      "Elegant cashmere scarf, ideal for adding warmth and a touch of luxury.",
    price: 80,
    soldedPrice: 75,
    onSolde: false,
    image: [img26],
  ...
  },
  {
    ...
    description:
      "Warm and comfortable beanie, ideal for keeping kids warm during cold days.",
    price: 60,
    soldedPrice: 75,
    onSolde: false,
    image: [img27],
  ...
  },
  {
    ...
    description:
      "High-quality leather belt with a durable buckle, perfect for formal wear.",
    price: 140,
    soldedPrice: 75,
    onSolde: false,
    image: [img28],
  ...
  },
  {
    ...
    name: "Women Sun Hat",
    description:
      "Wide-brimmed sun hat, perfect for beach days and outdoor activities.",
    price: 120,
    soldedPrice: 75,
    onSolde: false,
    image: [img29],
  ...
  },
  {
    ...
    description:
      "Stylish polarized sunglasses for kids, providing excellent UV protection.",
    price: 60,
    soldedPrice: 75,
    onSolde: false,
    image: [img30],
